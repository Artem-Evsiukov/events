      ...
      return property;
		...
		91: [
			function (require, module, exports) {
				...
				var Mousewheel__default =
					/*#__PURE__*/ _interopDefaultLegacy(Mousewheel)
				var Navigation__default =
					/*#__PURE__*/ _interopDefaultLegacy(Navigation)
				var Pagination__default =
					/*#__PURE__*/ _interopDefaultLegacy(Pagination)
				...
				var Controller__default =
					/*#__PURE__*/ _interopDefaultLegacy(Controller)
				var A11y__default = /*#__PURE__*/ _interopDefaultLegacy(A11y)
				var History__default = /*#__PURE__*/ _interopDefaultLegacy(History)
				var HashNavigation__default =
					/*#__PURE__*/ _interopDefaultLegacy(HashNavigation)
				var Autoplay__default = /*#__PURE__*/ _interopDefaultLegacy(Autoplay)
				var EffectFade__default =
					/*#__PURE__*/ _interopDefaultLegacy(EffectFade)
				var EffectCube__default =
					/*#__PURE__*/ _interopDefaultLegacy(EffectCube)
				var EffectFlip__default =
					/*#__PURE__*/ _interopDefaultLegacy(EffectFlip)
				var EffectCoverflow__default =
					/*#__PURE__*/ _interopDefaultLegacy(EffectCoverflow)
		...
		92: [
			function (require, module, exports) {
				...
				var _bodyHeight = _interopRequireDefault(
					require('./helpers/body-height')
				)
			...
			},
			{
				'./components/map': 93,
				'./components/popup': 94,
				'./components/select': 95,
				'./components/swiper': 96,
				'./components/tabs': 97,
				'./helpers/body-height': 98,
				'./helpers/mob-height': 99,
			},
		],
		93: [
			function (require, module, exports) {
				...
				function initMap() {
					var mapList = document.querySelectorAll('.js-map')
					if (!mapList.length) return
					ymaps.ready(function init() {
						var center = [53.8954974192739, 27.53528314185718]
						ymaps.ready(function init() {
							mapList.forEach(function (el) {
				...
				var Popups = /*#__PURE__*/ (function () {
					function Popups() {
						...
						_defineProperty(
							this,
							'CLOSE_BTN',
							document.querySelectorAll('.js-popup-close')
						)
							...
							if (_this.POPUP_SHOW.length) {
								_this.POPUP_SHOW.forEach(function (opener) {
									opener.addEventListener('click', function (e) {
										e.preventDefault()
										var overlay = e.target.closest(_this.SELECTOR_SHOW).dataset
											.overlay
										var trigger = e.target.closest(_this.SELECTOR_SHOW).dataset
											.trigger
						...
						_defineProperty(this, 'hidePopup', function () {
							...
							if (
								_this.OVERLAY &&
								_this.OVERLAY.classList.contains(_this.CLASS_ACTIVE)
							) {
						...
						_defineProperty(this, 'showPopup', function (target, overlay) {
							var currentPopup = document.querySelector(
								'[data-popup="'.concat(target, '"]')
							)
					...
					_createClass(Popups, [
						{
							...
							value: function showOberlay() {
								if (
									this.OVERLAY &&
									!this.OVERLAY.classList.contains(this.CLASS_ACTIVE)
								) {
		...
		96: [
			function (require, module, exports) {
				...
				function initSwiper() {
					var posterSlider = new _bundle['default']('.js-poster-slider', {
						slidesPerView: 1,
						loop: true,
						pagination: {
							el: '.js-poster-nav',
						...
						navigation: {
							nextEl: '.js-poster-next',
							prevEl: '.js-poster-prev',
						},
						breakpoints: {
							1024: {
								slidesPerView: 1,
					...
					var infoSlider = new _bundle['default']('.js-info-slider', {
						slidesPerView: 1.28,
						spaceBetween: 12,
						loop: true,
						autoplay: {
					...
					var eventsSlider = new _bundle['default']('.js-events-slider', {
						slidesPerView: 1.2,
						spaceBetween: 16,
						loop: true,
						pagination: {
					...
					var playgroundsSlider = new _bundle['default'](
						'.js-playgrounds-slider',
						{
							slidesPerView: 1.2,
							spaceBetween: 16,
							...
							loop: true,
							pagination: {
								el: '.js-playgrounds-nav',
								clickable: true,
							},
							navigation: {
								nextEl: '.js-playgrounds-next',
								prevEl: '.js-playgrounds-prev',
							},
							breakpoints: {
								375: {
									slidesPerView: 1.2,
					...
					var viewedSlider = new _bundle['default']('.js-viewed-slider', {
						slidesPerView: 2.6,
						spaceBetween: 30,
						loop: true,
						pagination: {
					...
					function resize() {
						...
						window.addEventListener('resize', function () {
							...
							changed = setTimeout(updateSwiper, 200)
						})
					}
		...
		97: [
			function (require, module, exports) {
				...
				exports['default'] = void 0
				var SELECTOR_WRAP = '.js-tabs'
				var SELECTOR_BTNS = '.js-tabs-buttons'
				var SELECTOR_BTN = '[data-tab]'
				var SELECTOR_CONTENT = '[data-content]'
				var CLASS_ACTIVE = 'active'

				function initTabs() {
					var wrapList = document.querySelectorAll(SELECTOR_WRAP)
					if (!wrapList.length) return
					wrapList.forEach(function (wrap) {
						var listTrigger = wrap.querySelector(SELECTOR_BTNS)
						if (!listTrigger) return
						var btnList = listTrigger.querySelectorAll(SELECTOR_BTN)
						listTrigger.addEventListener('click', function (e) {
							...
							if (btn) {
								...
								showContent(btn.getAttribute('data-tab'), wrap)
							}
						})
					})

					function showContent(id, wrap) {
						var contentList

						if (id !== 'all') {
							contentList = wrap.querySelectorAll(
								"[data-content='".concat(id, "']")
							)
						} else {
							contentList = wrap.querySelectorAll(SELECTOR_CONTENT)
						}

						var group = contentList[0].getAttribute('data-group')
						var contentAll = wrap.querySelectorAll(SELECTOR_CONTENT)

						if (group) {
							contentAll = wrap.querySelectorAll(
								"[data-group='".concat(group, "']")
							)
						}

						contentAll.forEach(function (el) {
							return el.classList.remove(CLASS_ACTIVE)
						})
						contentList.forEach(function (el) {
							return el.classList.add(CLASS_ACTIVE)
						})
					}
				}
				...
				var initBodyHeight = function initBodyHeight() {
					...
					var initHeight = function initHeight(wrap) {
						var head = wrap.querySelector(HEAD_SELECTOR),
							...
							wrapHeight =
								+window.getComputedStyle(wrap).height.slice(0, -2) -
								+window.getComputedStyle(wrap).paddingBottom.slice(0, -2)
						var outherHead
