...
},{"./components/map":93,"./components/popup":94,"./components/select":95,"./components/swiper":96,"./components/tabs":97,"./helpers/body-height":98,"./helpers/mob-height":99}],93:[function(require,module,exports){
"use strict";
...
},{"./../helpers/body-height":98}],95:[function(require,module,exports){
"use strict";
...
function initSwiper() {
  ...
  var playgroundsSlider = new _bundle["default"]('.js-playgrounds-slider', {
    slidesPerView: 1.2,
    spaceBetween: 16,
...
},{"swiper/bundle":91}],97:[function(require,module,exports){
"use strict";
...
function initTabs() {
  ...
  function showContent(id, wrap) {
    ...
    if (id !== 'all') {
      contentList = wrap.querySelectorAll("[data-content='".concat(id, "']"));
    } else {
    ...
    if (group) {
      contentAll = wrap.querySelectorAll("[data-group='".concat(group, "']"));
    }
